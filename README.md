...
```javascript
Float32Results = require( 'https://cdn.jsdelivr.net/gh/stdlib-js/stats-base-ztest-one-sample-results-float32@umd/browser.js' )
```

To vendor stdlib functionality and avoid installing dependency trees for Node.js, you can use the UMD server build:

```javascript
var Float32Results = require( 'path/to/vendor/umd/stats-base-ztest-one-sample-results-float32/index.js' )
```
...
[stdlib-license]: https://raw.githubusercontent.com/stdlib-js/stats-base-ztest-one-sample-results-float32/main/LICENSE
